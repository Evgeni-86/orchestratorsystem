package com.taskorchestrator.task_registry_gex.service;
...
import com.taskorchestrator.task_registry_gex.adapter.in.web.mapper.graph.GraphDtoMapper;
...
import com.taskorchestrator.task_registry_gex.adapter.out.persistence.mapper.graph.GraphEntityMapper;
...
import com.taskorchestrator.task_registry_gex.application.core.domain.validator.GraphValidator;
import com.taskorchestrator.task_registry_gex.application.core.domain.validator.ValidationResult;
...
import com.taskorchestrator.task_registry_gex.application.core.service.GraphServiceImpl;
...
class GraphServiceTest {
  ...
  private void setGraphValidatorField(GraphServiceImpl service, GraphValidator validator) {
    try {
      var field = GraphServiceImpl.class.getDeclaredField("graphValidator");
